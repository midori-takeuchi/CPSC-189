...
def plot_posn(t_arr, loargs):
    ...
    """
    for (a, d) in loargs:
        pyplt.plot(t_arr, position_arr(t_arr, a, d))
...
#In the Python console window:
#
#plot_posn(np.arange(0, 1, 0.01), [(100, -0.1), (95, -0.12)])
